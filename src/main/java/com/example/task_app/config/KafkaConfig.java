...
import com.example.task_app.kafka.MessageDeserializer;
...
public class KafkaConfig<T> {
    ...
    kafkaListenerContainerFactory(@Qualifier("consumerListenerFactory") ConsumerFactory<String, Object> consumerFactory) {
